...
\begin{document}
	...
	\chapter{Bewertungen und Metriken auf ${\bZ}$}
	...
	\newpar
	Unser erstes Ziel in diesem Vortrag, wird es sein, diese Form von Konvergenz und die daraus entstehenden "Zahlen mit unendlich vielen Stellen vor dem Komma" zu formalisieren. Wir werden eine Familie von Metriken $\abs{-}_p$ einführen, sodass in jeder Metrik $\abs{-}_p$ die Folge $a_n = p^n$ tatsächlich zur Nullfolge wird.
	...
	\begin{proposition}
		...
		eine Metrik auf $K$.
	\end{proposition}
	Sei $(G, +, \geq)$ eine linear geordnete Gruppe. Wir fügen zu $G$ ein Element $\infty$ hinzu, welches die erwarteten Eigenschaften bezüglich der Ordnung und Gruppenoperation hat:
	\begin{itemize}
		\item $\forall g \in G : \infty \geq g$
		\item $\forall g \in G : \infty + g = g + \infty = \infty + \infty = \infty$
	\end{itemize}
	\iffalse
	\begin{definition}
	...
	\end{definition}
	\begin{example}
		Es gilt $\nu_5(75) = \nu_5(3 \cdot 5^2) = 5^2 = 25$ und $\nu_5(50) = \nu_5(2 5^2) = 5^2 = 25$. Für die Summe gilt $\nu_5(125) = \nu_5(5^3) = 5^3$.
	\end{example}
	...
	\begin{proposition}
		...
		\end{align*}
		wobei $m \in \bZ$, $d_n \in \bZ / p\bZ$, konvergiert in $\bQ_p$. Wir nennen die Folge $d_n$ die \tbf{$p$-adische Darstellung von $x$}.
	\end{proposition}
	...
	\end{proposition}
	\noindent (Hier Bezug zum Zweierkomplement in der Informatik ziehen)
